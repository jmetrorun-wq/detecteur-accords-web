...
def download_audio(video_id: str, output_path_noext: str) -> str:
    """Télécharge l'audio de la vidéo Dailymotion `video_id` en wav vers
    `output_path_noext + '.wav'`, retourne ce chemin. Dailymotion renvoie
